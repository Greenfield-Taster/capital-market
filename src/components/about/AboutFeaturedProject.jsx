// Версія 2: Контрастний стиль з темним фоном
...
const AboutFeaturedProject = ({ t }) => {
  return (
    <section className="featured-project-section contrast">
      <div className="featured-project-container">
        <div className="featured-content animate-on-scroll fade-in">
          <h2 className="section-title">{t("about.featuredProject.title")}</h2>
          <p className="featured-description">
            {t("about.featuredProject.description")}
          </p>
        </div>
        <div className="featured-project-image animate-on-scroll zoom-in">
          <img
